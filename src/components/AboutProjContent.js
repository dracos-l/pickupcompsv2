  ...
  return (
    <div className="aboutWrapper">
      <div className='about'>
        ...
        <h3>Front-End</h3>
        <p>
          I (Logan) created our frontend using React with <a href="https://www.npmjs.com/package/react-router-dom" target="_blank" rel="noopener noreferrer">github repo</a>
          or <a href="https://github.com/dracos-l/pickupcompsv2/blob/master/README.md" target="_blank" rel="noopener noreferrer">README</a>.
          Also feel free to reach out to us with any questions or if you want to contribute to the project!bpage, such as Modal and various hooks. <br /> <br />
          ...
          I'm proud of the final product, and as we continue to improve both the front and back end, I'm sure I'll be able to make it even better. After all, this is only version 2! (see version 1 <a href="https://dracos-l.github.io/Pickup_Comps/" target="_blank" rel="noopener noreferrer">here</a> (<b>WARNING: It is ugly and much worse than this version</b>)) <br />
        </p>
        <h3>Back-End</h3>
        <p>
