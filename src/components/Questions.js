export const questions = [
  {
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many shots you take in the paint and how efficient you are at making them?",
    ...
    "statKey1": "Paint_volume_pm_percentile",
    "statKey2": "Paint_efficiency_percentile"
  },
  {
    "id": 2,
    "title": "Midrange",
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many mid range shots you take and how efficient you are at making them?",
    ...
    "placeHolderText1": "Volume",
    "placeHolderText2": "Efficiency",
    "statKey1": "Midrange_volume_pm_percentile",
    "statKey2": "Midrange_efficiency_percentile"
  },
  {
    "id": 3,
    "title": "Corner",
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many corner three-pointers you take and how efficient you are at making them?",
    ...
    "placeHolderText1": "Volume",
    "placeHolderText2": "Efficiency",
    "statKey1": "Corner_volume_pm_percentile",
    "statKey2": "Corner_efficiency_percentile"
  },
  {
    "id": 4,
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many above the break three-pointers you take and how efficient you are at making them?",
    ...
    "placeHolderText1": "Volume",
    "placeHolderText2": "Efficiency",
    "statKey1": "Above_the_break_volume_pm_percentile",
    "statKey2": "Above_the_break_efficiency_percentile"
  },
  {
    "id": 5,
    "title": "Tight",
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many tight shots you take and how efficient you are at making them? A tight shot is defined as a shot where the nearest defender is less than 4 feet from you.",
    ...
    "placeHolderText1": "Volume",
    "placeHolderText2": "Efficiency",
    "statKey1": "Tight_volume_pm_percentile",
    "statKey2": "Tight_efficiency_percentile"
  },
  {
    "id": 6,
    "title": "Open",
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many open shots you take and how efficient you are at making them? An open shot is defined as a shot where the nearest defender is more than 4 feet from you.",
    ...
    "placeHolderText1": "Volume",
    "placeHolderText2": "Efficiency",
    "statKey1": "Open_volume_pm_percentile",
    "statKey2": "Open_efficiency_percentile"
  },
  {
    "id": 7,
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many catch and shoot shots you take and how efficient you are at making them? A catch and shoot shot is defined as a shot at least 10 feet from the basket off the catch.",
    ...
    "placeHolderText1": "Volume",
    "placeHolderText2": "Efficiency",
    "statKey1": "Catch_and_Shoot_Volume_percentile",
    "statKey2": "Catch_and_Shoot_Efficiency_percentile"
  },
  {
    "id": 8,
    "title": "Pull-Up",
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many pull up shots you take and how efficient you are at making them? A pull up jumper is defined as a shot at least 10 feet from the basket off the dribble.",
    ...
    "statKey1": "Paint_defense_volume_pm_percentile",
    "statKey2": "Paint_defense_deterance_percentile"
  },
  {
    "id": 10,
    ...
    "explanationText": "Compare to the people you play pickup basketball against, where do you rank compare to your friends on the court 1 through 10 out of the 10 people playing 5v5 when it comes to how many shots you defend on the perimeter and how effective you are at stopping them? Take into account that perimeter deterrence doesn’t equal steals, but is more about how you affect scorers. Also, sometimes the best perimeter defenders are avoided and the worst defenders are targeted: though, this doesn’t always happen in pickup.",
    ...
    "placeHolderText1": "Volume",
    "placeHolderText2": "Deterrence",
    "statKey1": "Perimeter_defense_volume_pm_percentile",
    "statKey2": "Perimeter_defense_deterance_percentile"
  },
  {
    "id": 11,
    "title": "Playmaking",
    ...
    "statKey1": "AST_PCT_percentile",
    "statKey2": "TOV_PCT_percentile"
  },
  {
    "id": 12,
    "title": "Rebounding",
    ...
    "statKey1": "OREB_PCT_percentile",
    "statKey2": "DREB_PCT_percentile"
  }
];