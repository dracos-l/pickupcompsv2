      ...
      <main>
        ...
        <div className="introText">
          ...
          <p>
            ...
            So, I ranked by volume of open shots at 8th best and my efficiency at 5th best out of the 10 players on the court. <br /><br />
        ...
        <div className="introButtons">
          <Link to="/Form/Paint" style={{ textDecoration: 'none' }}>
            <button className="startButton" > Start New Form </button>
          </Link>
          <Link to="/Edit" style={{ textDecoration: 'none' }}>
            <button className="editButton"> Edit Existing Form </button>
          </Link>
        </div>
      </main>
    </div>
